...
namespace MercivKit
{
    ...
    /// var actions = new MercivInputActions();
    ///
    ...
    /// </example>
    /// </remarks>
    public class MercivInputActions : IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @MercivInputActions()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""MercivInputActions"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ""controlSchemes"": [
        ...
        {
            private @MercivInputActions m_Wrapper;
            public PlayerActions(@MercivInputActions wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @MercivInputActions m_Wrapper;
            public UIActions(@MercivInputActions wrapper) { m_Wrapper = wrapper; }
